...
public class EmpreendedorService {  // Alteração para EmpreendedorService
    ...
    public Empreendedor buildEmpreendedor(CadastroEmpDTO cadastroEmpDTO) {
        ...
        emailService.enviarEmailTexto(empreendedor.getEmail(), "EducaProTech", "Seja muito bem-vindo(a) a nossa plataforma, onde a paixão pela tecnologia encontra o aprendizado dinâmico e empolgante! É com grande entusiasmo que damos as boas-vindas a sua empresa.");
