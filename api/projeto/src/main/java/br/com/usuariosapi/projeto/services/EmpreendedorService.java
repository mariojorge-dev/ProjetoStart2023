...
public class EmpreendedorService {  // Alteração para EmpreendedorService
    ...
    public Empreendedor buildEmpreendedor(CadastroEmpDTO cadastroEmpDTO) {
        ...
        emailService.enviarEmailTexto(empreendedor.getEmailemp(), "Cadastro feito com sucesso", "Bem Vindo a Educa Protech acesse nosso site para maiores informações.");
        return empreendedor;
    }
